...
#default_censor_style = [ 'blur', 8 ] # 第二项是模糊程度。数值越高，模糊程度越强。一般为20。
...
item_overrides = {
        ...
        'face_femme': {'censor_style': [ 'bar', (0,0,0) ], 'min_prob': 0.60, 'width_area_safety': 0.2, 'height_area_safety': 0.2, 'shape': 'circle' },
